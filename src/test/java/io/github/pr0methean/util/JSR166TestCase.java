...
abstract class JSR166TestCase {
  ...
  public void tearDown() throws Exception {
    ...
    if (t != null) {
      if (t instanceof Error) throw (Error) t;
        ...
        AssertionError afe = new AssertionError(t.toString());
        afe.initCause(t);
        throw afe;
      }
    }

    if (Thread.interrupted()) throw new AssertionError("interrupt status set in main thread");
  }
  ...
  public void threadUnexpectedException(Throwable t) {
    ...
    if (t instanceof RuntimeException) throw (RuntimeException) t;
      ...
      AssertionError afe = new AssertionError("unexpected exception: " + t);
      afe.initCause(t);
      throw afe;
    }
  }
  ...
  /** Sleeps until the given time has elapsed. Throws AssertionError if interrupted. */
  void sleep(long millis) {
    try {
      delay(millis);
    } catch (InterruptedException ie) {
      AssertionError afe = new AssertionError("Unexpected InterruptedException");
      afe.initCause(ie);
      throw afe;
    }
  }
  ...
  /**
   * A CyclicBarrier that uses timed await and fails with AssertionErrors instead of throwing
   * checked exceptions.
   */
  public class CheckedBarrier extends CyclicBarrier {
    ...
    public int await() {
      try {
        ...
        AssertionError afe = new AssertionError("Unexpected exception: " + e);
        afe.initCause(e);
        throw afe;
      }
    }
